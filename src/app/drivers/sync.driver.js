...
// Config the chromeStorageSync backend, using options set in the config.
...
function clear(callback) {
    ...
    var promise = new Promise(function (resolve, reject) {
        self.ready().then(function () {
            ...
            chromeStorageSync.clear(function () {
                resolve();
            });
    ...
    var promise = new Promise(function (resolve, reject) {
        self.ready().then(function () {
            try {
                ...
                chromeStorageSync.get(prefixedKey, function (data) {
                    if (data[prefixedKey]) {
...
function iterate(callback) {
    ...
    var promise = new Promise(function (resolve, reject) {
        self.ready().then(function () {
            try {
                var db = {};
                chromeStorageSync.get(null, function (data) {
                    db = data;
...
function removeItem(key, callback) {
    ...
    var promise = new Promise(function (resolve, reject) {
        self.ready().then(function () {
            ...
            chromeStorageSync.remove(prefixedKey, function () {
                resolve();
            });
        }).catch(reject);
    });
            ...
            _serialize(value, function (value, error) {
                if (error) {
                    ...
                    try {
                        ...
                        chromeStorageSync.set(obj, function () {
...
export const chromeStorageSyncDriver = {
    _driver: 'chromeStorageSyncDriver',
